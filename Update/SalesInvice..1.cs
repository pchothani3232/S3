            ...
            try
            {
                using (SqlConnection con = new SqlConnection(CommClass.Connection))
                {
                    ...
                    */
                    ...
                    salesInsert.GrossAmount = txtGrossAmount.Text.Trim();
                    salesInsert.DiscountPer = txtDiscountValue.Text.Trim();
                    salesInsert.DiscountAmount = txtDiscountAmt.Text.Trim();
                    salesInsert.Roundoff = txtRoundOffDiscount.Text.Trim();
                    salesInsert.Total_Amount = txtNetAmount.Text.Trim();
